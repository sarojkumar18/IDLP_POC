...
@Configuration
@Slf4j
public class SiteMongoDbConfiguration extends AbstractMongoClientConfiguration {
  ...
  @Override
  @Bean("siteMongoTemplate")
  public MongoTemplate mongoTemplate(@Qualifier("siteMongoDbFactory")
  ...
  @Bean("siteMongoClient")
  public MongoClient mongoClient() {
    String mongoDbUri = "mongodb://admin:AcTmOnGoIaNcE0014@10.33.144.73:23757/?authSource=admin&authMechanism=SCRAM-SHA-1&ssl=true&tlsAllowInvalidHostnames=true";
